...
const average = videogames.reduce((accumulator,videogame) => accumulator + videogame.score,0) /videogames.length;
console.log(average);

const rpgFind = videogames.find(videogame => videogame.genders == "RPG");
console.log(rpgFind);